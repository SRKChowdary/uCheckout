...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/ABAuthenticator/ABAuthenticator.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ABCoreComponent/ABCoreComponent.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ABCoreNetwork/ABCoreNetwork.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ABCoreUI/ABCoreUI.framework"
