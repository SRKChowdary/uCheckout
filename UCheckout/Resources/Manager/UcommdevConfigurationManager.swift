//
//  UcommdevConfigurationManager.swift
//  UCheckout
//
...
class UcommdevConfigurationManager {
    
    static let manager = UcommdevConfigurationManager()
    var baseURL = ""
    ...
    func getBaseParameter() {
        ...
        guard let pathOfPlist = Bundle.main.path(forResource: "UcommdevConfiguration", ofType: "plist") else {
            fatalError()
        }
