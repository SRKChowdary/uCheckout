//
//  ScanandgodevjsConfigurationManager.swift
//  UCheckout
//
...
class ScanandgodevjsConfigurationManager {
    
    static let manager = ScanandgodevjsConfigurationManager()
    var baseURL = ""
    ...
    func getBaseParameter() {
        ...
        guard let pathOfPlist = Bundle.main.path(forResource: "ScanandgodevjsConfiguration", ofType: "plist") else {
            fatalError()
        }
